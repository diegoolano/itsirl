...
def get(env,var):
        ...
        if env == "0720_600k_full_orig":
                ...
                TRAIN_DATA_TINY = "train/training_00*.json"   #only load 10 shards as opposed to 127
                TRAIN_DATA_999 = "train999/training_00*.json"   #uses 99.99 percent of data as 
                DEV_DATA = "validation/0721_600k_all_validation_examples.json"
                DEV_DATA_TINY = "validation/0721_600k_all_validation_examples_100.json"
                DEV_DATA_999 = "validation/0721_600k_all_validation_examples_pt01.json"
                DEV_DATA_999_TINY = "validation/0721_600k_all_validation_examples_pt01_tiny.json"
        ...
        get_dict = {'FILE_ROOT': FILE_ROOT, 'EXP_ROOT': EXP_ROOT, 
                    'TRAIN_DATA': TRAIN_DATA, 'TRAIN_DATA_TINY':TRAIN_DATA_TINY, 'TRAIN_DATA_999': TRAIN_DATA_999,
                    'DEV_DATA': DEV_DATA, 'DEV_DATA_TINY': DEV_DATA_TINY, 'DEV_DATA_999': DEV_DATA_999, 
                    'EVAL_DATA': EVAL_DATA, 'DEV_DATA_999_TINY': DEV_DATA_999_TINY,
...
TYPES_2_MENTIONS = {
        '0720_600k_full_orig': "0721_600k_all_training_examples_with_concepts_and_categories_uniq_mentions_links.tsv",
}              
